...
def extract_variants(page: Page):
...
def extract_variations_matrix(page: Page):
    try:
...
def crawl_amazon_product(url: str, amazon_params: AmazonParams):
...
if __name__ == '__main__':
    res = crawl_amazon_product("file:///data/dev/xtracted/crawlers-python/tests/en_GB/gopro.html",
